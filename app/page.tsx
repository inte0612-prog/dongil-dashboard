...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-muted/30">
      ...
      <div className="mx-auto max-w-5xl px-6 pt-4 pb-8 space-y-12">
        {/* 기능 카드 — 스크롤 없이 바로 선택 가능 */}
        <section>
            ...
            {FEATURE_CARDS.map((card) => {
              ...
              return (
                <Link
                  key={card.title}
                  href={card.href}
                  className="rounded-lg border bg-background p-6 flex flex-col gap-4 transition-shadow hover:shadow-md hover:border-primary/30"
                >
                  ...
                  <span className="self-start inline-flex items-center gap-1.5 rounded-md bg-primary px-3 py-1.5 text-xs font-medium text-primary-foreground transition-opacity hover:opacity-90">
                    바로가기
        ...
        {/* 4단계 가이드 */}
        <section>
          <h2 className="mb-6 text-xl font-semibold text-foreground">시작하기 — 4단계 가이드</h2>
